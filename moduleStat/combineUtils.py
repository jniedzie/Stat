...
def runSinglePoint(path_, mZprime, mDark, rinv, alpha, categories, method, runSingleCat, singleYear=""):
    ...
    if(os.path.exists(path)):
        ...
        if len(categories)>1:
            ...
            print cmd
            os.system(cmd)
            runCombine("combine -M AsymptoticLimits  -n SVJ_mZprime" + mZprime + "_mDark" + mDark + "_rinv" + rinv + "_alpha" + alpha + " -\
m " + mZprime + " SVJ_mZprime" + mZprime + "_mDark" + mDark + "_rinv" + rinv + "_alpha" + alpha  + "_"  + method + ".txt", "asymptotic_mZprime" + mZprime + "_mDark" + mDark + "_rinv" + rinv + "_alpha" + alpha  + "_" + method + ".log")
            ...
            for cat in categories:
                ...
                if(runSingleCat): runCombine("combine -M AsymptoticLimits  -n SVJ_mZprime" + mZprime + "_mDark" + mDark + "_rinv" + rinv + "_alpha" + alpha + "_" + cat + " -m" + mZprime + " SVJ_mZprime" + mZprime + "_mDark" + mDark + "_rinv" + rinv + "_alpha" + alpha  + "_" + cat +".txt", "asymptotic_mZprime" + mZprime + "_mDark" + mDark + "_rinv" + rinv + "_alpha" + alpha  + "_" + cat + ".log")  
